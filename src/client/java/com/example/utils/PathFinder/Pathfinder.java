...
public class Pathfinder {
    ...
    public static boolean isWalkable(BlockPos pos, World world) {
        boolean isGroundWalkable = world.getBlockState(pos).isAir() ||
                world.getBlockState(pos).getBlock().equals(Blocks.SHORT_GRASS) ||
                world.getBlockState(pos).getBlock().equals(Blocks.TALL_GRASS) ||
                world.getBlockState(pos).getBlock().equals(Blocks.FERN) ||
                world.getBlockState(pos).getBlock().equals(Blocks.LARGE_FERN) ||
                world.getBlockState(pos).getBlock().equals(Blocks.SEAGRASS) ||
                world.getBlockState(pos).getBlock().equals(Blocks.TALL_SEAGRASS);
        ...
        boolean isAboveClear = world.getBlockState(pos.up()).isAir() ||
                world.getBlockState(pos.up()).getBlock().equals(Blocks.SHORT_GRASS) ||
                world.getBlockState(pos.up()).getBlock().equals(Blocks.TALL_GRASS) ||
                world.getBlockState(pos.up()).getBlock().equals(Blocks.FERN) ||
                world.getBlockState(pos.up()).getBlock().equals(Blocks.LARGE_FERN) ||
                world.getBlockState(pos.up()).getBlock().equals(Blocks.SEAGRASS) ||
                world.getBlockState(pos.up()).getBlock().equals(Blocks.TALL_SEAGRASS);
