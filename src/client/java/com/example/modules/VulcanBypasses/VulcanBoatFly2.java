/*
    This is the Default ThunderHack boatfly, but configured to bypass vulcan.
 */
...
public class VulcanBoatFly2 extends Module {
    ...
    private final Setting<Boolean> automount = new Setting<>("AutoMount", false);
    public final Setting<Boolean> allowShift = new Setting<>("AllowShift", true);
    private final Setting<Float> speed = new Setting<>("Speed", 18f, 0.0f, 25f);
    private final Setting<Float> yspeed = new Setting<>("YSpeed", 3f, 0.0f, 10f);
    ...
    private final Setting<Boolean> pause = new Setting<>("Pause", true).addToGroup(advanced);
    private final Setting<Integer> enableticks = new Setting<>("EnableTicks", 1, 1, 100, v -> pause.getValue()).addToGroup(advanced);
    private final Setting<Integer> waitTicks = new Setting<>("WaitTicks", 5, 5, 100, v -> pause.getValue()).addToGroup(advanced);
    private final Setting<Boolean> stopunloaded = new Setting<>("StopUnloaded", false).addToGroup(advanced);
    private final Setting<Float> timer = new Setting<>("Timer", 0.34f, 0.1f, 5f).addToGroup(advanced);
    public final Setting<Boolean> hideBoat = new Setting<>("HideBoat", false).addToGroup(advanced);
